...
// Ejemplo de una consulta para contar publicaciones y usuarios
try {
    $stmt = $pdo->prepare("SELECT COUNT(*) AS total_posts FROM publicaciones");
    $stmt->execute();
    $total_posts = $stmt->fetchColumn();

    $stmt = $pdo->prepare("SELECT COUNT(*) AS total_users FROM usuarios");
    $stmt->execute();
...
<div class="wrapper">
    ...
    <footer class="main-footer">
        ...
        <strong>Creado por <a href="#">redsocial</a>.</strong> Todos los derechos reservados.
    </footer>
